...
/*
Plugin Name: NpLogin
Plugin URI: http://www.dosurfin.com/
Description: NpLogin for WordPress login.
Author: AnupRaj
Author URI: http://www.anupraj.com.np/
Version: 0.1
...
function nplogin () {
	...
	// output styles
	echo '<link rel="stylesheet" type="text/css" href="' . $pluginUrl . '/nplogin.css" />';
	echo '<style>';
...
<div class="wrap">
	...
	<div class="nplogin_notice">
		...
		<p>Please send us your feedback on <a href="http://www.dosurfin.com/products/wp-plugins/nplogin/" target="_blank">DoSurfIn.Com</a><br />
		</p>
		<ul>
...
function nplogin_footer() {
	...
	$pluginUrl = get_option ('siteurl') . $pluginPath . plugin_basename (dirname (__FILE__)) ;
	echo '<div >Thank you for supporting <a href="http://www.dosurfin.com/products/wp-plugins/nplogin/" title="NpLogin" style="padding: 1px 1px 1px 20px;background:url('.$pluginUrl.'/images/ar.gif) left top no-repeat;">"NpLogin"</a> and mountains.  <br /></div>';
}
...
add_action( 'in_admin_footer', 'nplogin_footer' );
